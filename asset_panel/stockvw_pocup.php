...
<?php
if(isset($_POST['p_id'])) // Delete query
{
 $id = $_POST['p_id'];
?>
                       <!--  <div class="col-lg-12"> -->
  ...
  <div class="panel-body">
    ...
    {   
       ...
       $pagination.= "</div>\n";       
                 ...
                 $result = mysqli_query($con,"SELECT y.*,y.id as yid,z.* FROM  aset_stock_entry y,aset_poc_update z WHERE  y.id = z.name_id AND y.auto_serial = '$id' order by z.id limit $start,$limit");
      ...
      // }
      //  else{
      //    echo "<tr align='center'><td colspan='12'> No Pollution update </td></tr>";
      // }
