...
if ( isset($_GET['pdf']) ) 
{
   ...
   // Set a simple Footer including the page number
	...
	ob_end_flush();
  	...
  	$pdfString =$mpdf->Output("Pollution Report".date("Y-m-d").".pdf", 'D');
  	exit();
}
...
if ( isset($_GET['excel']) ) 
{
	...
	header("Content-Disposition: attachment; filename=Pollution Report".date("Y-m-d").".xls");
	echo $html;
}
