...
if($_SESSION['ERP_SESS_ID']!='1' && $_SESSION['ERP_SESS_ID']!='12' && $_SESSION['ERP_SESS_ID']!='42')
{
...
<?php
                       ...
                       //    $total = count($ftch_req)
                            $names = array();
                           $vet = mysqli_query($con,"SELECT req_to FROM `aset_req_to` WHERE `req_id` = '$id'"); 
                          ...
                          $wet = mysqli_query($con,"SELECT req_by FROM `aset_req_to` WHERE `req_id` = '$id'");
