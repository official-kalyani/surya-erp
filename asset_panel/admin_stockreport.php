            ...
            <div id="page-wrapper">
                ...
                <!-- Body Starts Here --> 
                                            ...
                                            if(isset($_POST['sdate']) || isset($_POST['tdate']) || isset($_POST['spname']))
                    {
                      ...
                      {
                        ?>
                         <a href="printreport_admin.php?sdate=<?php echo $_POST['sdate'];?>&tdate=<?php echo $_POST['tdate'];?>&spname=<?php echo $_POST['spname'];?>&select_search=<?php echo $_POST['select_search'];?>&empid=<?php echo $_SESSION['ERP_SESS_ID'] ;?>" class="btn btn-warning btn-xs" style="text-decoration:none;" target="_blank"><b>Print</b></a>
                         <a href="downloadreport_admin.php?sdate=<?php echo $_POST['sdate'];?>&tdate=<?php echo $_POST['tdate'];?>&spname=<?php echo $_POST['spname'];?>&select_search=<?php echo $_POST['select_search'];?>&empid=<?php echo $_SESSION['ERP_SESS_ID'] ;?>" class="btn btn-warning btn-xs" style="text-decoration:none;" ><b>Download</b></a>
                         <?php
                      }
                      else{
                        ?>
                <a href="printreport_admin.php?empid=<?php echo $_SESSION['ERP_SESS_ID'] ;?>" class="btn btn-warning btn-xs" style="text-decoration:none;"  target="_blank" ><b>Print</b></a>
                <a href="downloadreport_admin.php?empid=<?php echo $_SESSION['ERP_SESS_ID'] ;?>" class="btn btn-warning btn-xs" style="text-decoration:none;"><b>Download</b></a>
                <?php
                            ...
                            <div class="panel-heading" style="height:40px;">
                              <!--   <div class="row"> -->
                                    ...
                                    <form name="text_search" method="GET">
                                       ...
                                       <span>
                                        <button type="button" onClick='javascript:location.href="stockreport.php"' class="btn btn-primary btn-xs" style="font-weight: bold;">User Asset List</button>
                                         <?php
                                    if (in_array($_SESSION['ERP_SESS_ID'], $assetID)){
                                      ?>  
                                        <button type="button" onClick='javascript:location.href="admin_stockreport.php"' class="btn btn-default btn-md active btn-xs" style="text-decoration:none;">ADMIN ASSET LIST</button>
                                        <?php
                                      }
                                      ?>
                                    </span>
               ...
               if(isset($_POST['submitdt']))
                    {
                         ...
                         $pdate = $_POST['tdate'];
                         $SESSION['pdate']= $pdate;
                         $result = mysqli_query($con,"SELECT x.*,x.description as xdescription,y.sub_type FROM  aset_stock_entry x ,  aset_item_creation  y WHERE x.item_name = y.id AND x.asset_type = 'Admin'  AND x.date_purchase BETWEEN '$spdate' AND '$pdate' "); 
                    }
                ...
                if($search == 1)
                {
                    ...
                    $result = mysqli_query($con,"SELECT x.*,x.description as xdescription,y.sub_type FROM  aset_stock_entry x ,  aset_item_creation  y WHERE x.item_name = y.id AND x.asset_type = 'Admin' AND x.auto_serial LIKE '%$spname%'");
                }
                else if($search == 2)
                     {
                     $spname = mysqli_real_escape_string($con,$_GET['spname']);
                    $result = mysqli_query($con,"SELECT x.*,x.description as xdescription,y.sub_type FROM  aset_stock_entry x ,  aset_item_creation  y WHERE x.item_name = y.id AND x.asset_type = 'Admin' AND x.serial_no LIKE '%$spname%'");
                }
                else if($search == 3)
                     {
                     $spname = mysqli_real_escape_string($con,$_GET['spname']);
                    $result = mysqli_query($con,"SELECT x.*,x.description as xdescription,y.sub_type FROM  aset_stock_entry x ,  aset_item_creation  y WHERE x.item_name = y.id AND x.asset_type = 'Admin' AND x.description LIKE '%$spname%' ");
                }
                else if($search == 4)
                     {
                     $spname = mysqli_real_escape_string($con,$_GET['spname']);
                    $result = mysqli_query($con,"SELECT x.*,x.description as xdescription,y.sub_type FROM  aset_stock_entry x ,  aset_item_creation  y WHERE x.item_name = y.id AND x.asset_type = 'Admin' AND x.date_purchase LIKE '%$spname%'");
                }
                 else if($search == 5)
                     {
                     $spname = mysqli_real_escape_string($con,$_GET['spname']);
                    $result = mysqli_query($con,"SELECT x.*,x.description as xdescription,y.sub_type FROM  aset_stock_entry x ,  aset_item_creation  y WHERE x.item_name = y.id AND x.asset_type = 'Admin' AND x.supplier LIKE '%$spname%'");
                }
                 else if($search == 6)
                     {
                     $spname = mysqli_real_escape_string($coGET['spname']);
                    $result = mysqli_query($con,"SELECT x.*,x.description as xdescription,y.sub_type FROM  aset_stock_entry x ,  aset_item_creation  y WHERE x.item_name = y.id AND x.asset_type = 'Admin' AND x.inv_no LIKE '%$spname%' ");
                }
                else if($search == 7)
                     {
                     $spname = mysqli_real_escape_string($coGET['spname']);
                    ...
                    if(mysqli_num_rows($abc) > 0)
                    {
                     ...
                     {
                     $spname = mysqli_real_escape_string($coGET['spname']);
                    $result = mysqli_query($con,"SELECT x.*,x.description as xdescription, y.*,z.sub_type FROM aset_stock_entry  x, vw_aset_stock_assaignment y,aset_item_creation z WHERE x.auto_serial = y.asset_no AND x.item_name = z.id  AND x.asset_type = 'Admin' AND y.fullname LIKE '%$spname%' GROUP BY x.auto_serial ");
                }
                else if($search == 10)
                     {
                     $spname = mysqli_real_escape_string($con,$_GET['spname']);
                    $result = mysqli_query($con,"SELECT x.*,x.description as xdescription, y.*,z.sub_type FROM aset_stock_entry  x, vw_aset_stock_assaignment y,aset_item_creation z WHERE x.auto_serial = y.asset_no AND x.item_name = z.id AND x.asset_type = 'Admin' AND y.assaign_dt LIKE '%$spname%' GROUP BY x.auto_serial ");
                }
                 else if($search == 11)
                {
                  $spname = mysqli_real_escape_string($con,$_GET['spname']);
                  ...
                  else if($search == 12)
                {
                  ...
                  if($spname == '1')
                   {
                    $result = mysqli_query($con,"SELECT x.*,x.description as xdescription,x.id as xid, y.*, y.id as yid,z.* FROM aset_stock_entry  x, vw_aset_stock_assaignment y ,aset_item_creation z WHERE  x.auto_serial = y.asset_no AND x.item_name = z.id AND x.asset_type = 'Admin'  GROUP BY x.auto_serial");
                  }
                  else if($spname == '2')
                  {
                   
                   $result = mysqli_query($con,"SELECT  x.*,x.description as xdescription,y.*  from   aset_stock_entry x,aset_item_creation y  WHERE x.auto_serial  NOT IN (SELECT asset_no from aset_stock_assaignment GROUP BY asset_no) AND x.item_name = y.id AND x.asset_type = 'Admin'");
                ...
                $result = mysqli_query($con,"SELECT x.*,x.description as xdescription,y.sub_type,z.* FROM  aset_stock_entry x ,  aset_item_creation  y , prj_organisation z WHERE x.item_name = y.id AND x.organisation = z.id AND x.asset_type = 'Admin' AND x.organisation = '$spname' GROUP BY x.auto_serial");
              }
              else if($search == 14)
              {
                $spname = mysqli_real_escape_string($con,$_GET['spname']);
               ...
               else if($search == 15)
              {
                $spname = mysqli_real_escape_string($con,$_GET['spname']);
                   $result = mysqli_query($con,"SELECT x.*,x.description as xdescription, y.* FROM aset_stock_entry  x, aset_item_creation y WHERE x.item_name = y.id AND x.asset_type = 'Admin' AND x.aset_subcategory LIKE '%$spname%' GROUP BY x.auto_serial");
                    ...
                    {
                $result = mysqli_query($con," SELECT x.*,x.description as xdescription,y.sub_type FROM  aset_stock_entry x ,  aset_item_creation  y WHERE x.item_name = y.id AND x.asset_type = 'Admin' ORDER BY x.auto_serial limit $start,$limit"); 
