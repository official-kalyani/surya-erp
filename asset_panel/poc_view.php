...
<!-- DATETIMEPICKER CDNs -->
    ...
    <body>
      ...
      <div id="page-wrapper">
         <div class="row">
            <div class="col-lg-12">
              <h4 class="page-header">View Pollution</h4>
                <span><button onClick='javascript:location.href="pollution.php"' class="btn btn-warning mr-2" style="font-weight: bold; float: right;">Back to List</button>
                  </span>
          ...
          <div class="form-group">
                      ...
                      <label for="ins_no">Assigned Date:</label>
                      <?php  
                        if(mysqli_num_rows($query1)>0 )
                        {
