...
?>
  ...
  <div class="col-lg-12">
    <span style="float: right; margin: 10px;"> 
      <input type="button" name="cancel"  id="cancel" value="Close" class="btn btn-danger mr-2" >
    </span>
  </div>
          ...
          <tbody>
            <?php
              ...
              if ($page == 0) $page = 1;                  // If no page var is given, default to 1.
                ...
                $result = mysqli_query($con,"SELECT y.*,y.id as yid,z.* FROM  aset_stock_entry y,aset_update_ins z WHERE  y.id = z.name_id AND y.id = '$id' order by z.id DESC limit $start,$limit");
