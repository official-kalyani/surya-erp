        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
				...
				<fieldset>
                    ...
                    if ($user_id == 55) {
                        $query = mysqli_query($con, "SELECT x.*,x.id as xid,y.*,y.description as ydesc,z.*,w.km_reading  FROM aset_stock_assaignment x,aset_stock_entry y,aset_item_creation z,aset_km_reading w WHERE  x.status = 1 AND x.asset_no = y.auto_serial AND y.item_name = z.id  AND x.id = w.asset_no_id AND z.sub_type = '6' ORDER BY x.id ");
                    }else {
