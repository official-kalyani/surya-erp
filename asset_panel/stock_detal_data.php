...
<html lang="en">
    <head>
        ...
        <title>Stock Report View : Suryam Group</title>
         ...
         <div class="row">
            <div class="col-lg-12">
              <h4 class="page-header">Stock Details</h4>
                <span><button onClick='javascript:location.href="stockreport.php"' class="btn btn-warning mr-2" style="font-weight: bold; float: right;">Back to List</button>
                  </span>
          ...
          <div class="row">
            ...
            <form name="form" method="post" class="forms-sample" enctype="multipart/form-data">
              <fieldset>
                ...
                <div class="row">
                     ...
                     <div class="col-lg-4">
                      <div class="form-group">
                        <label for="serial">Serial No:</label>
                         ...
                         <input type="hidden" name="serial" id="serial" value="<?php echo $ftch_dtl->auto_serial; ?>">
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label for="itemname">Amount:</label>
                         <?php if($ftch_dtl->amount != ''){ echo $ftch_dtl->amount; } ?>
                      </div>
                    </div>
                     <?PHP
                    if($ftch_dtl->att_inv != '')
            ...
            <?php 
               $query = mysqli_query($con, "SELECT x.*,y.* FROM aset_stock_entry x,aset_item_creation y WHERE y.id = x.item_name AND x.id = '$id'")   ;
   $fetching = mysqli_fetch_object($query);
           
                           if($fetching->consumable == 'Asset' || $fetching->consumable == '')
                           {
                 ...
                 <?php
                    ...
                    <div class="row" >
                                 ...
                                 <!--  <label>&nbsp;</label> -->
                                      ...
                                      value="View Assignment History" class="btn btn-primary mr-2" >
                                      <input type="button" name="matainshow"  id="matainshow"
                                      value=" Maintenance Request History" class="btn btn-success mr-2" >
                                      <input type="button" name="upmaintain"  id="upmaintain"
                                      value="Updated Maintenance History" class="btn btn-primary mr-2" >
                                       <input type="button" name="insurance_history"  id="insurance_history"
                   value="insurance history" class="btn btn-success mr-2"  class="btn btn-success mr-2" > 
                     <input type="button" name="pol_history"  id="pol_history"
                   value="pollution history" class="btn btn-primary mr-2"  class="btn btn-success mr-2" >   
...
$(document).ready(function(){
    ...
    var asset = $("#serial").val();

    if( asset != ''){

        $.ajax({
        url:"assaignment_history.php",
        data:{s_d:asset},
        type:'POST',
    ...
    $("#matainshow").click(function(){
        ...
        $.ajax({
        url:"aset_maintenance_history.php",
        data:{s_id:asset},
        type:'POST',
        success:function(data) {
